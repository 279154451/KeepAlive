...
public class LocalService extends Service {
    ...
    class MyServiceConnection implements ServiceConnection {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            startRemoteService(LocalService.this,false);
            bindService(new Intent(LocalService.this, RemoteService.class),
                    serviceConnection, BIND_AUTO_CREATE);
        }
    }
    private void startRemoteService(Context context,boolean foreground) {
        Intent foregroundDaemonServiceIntent = new Intent(context, RemoteService.class);
        if(foreground){
